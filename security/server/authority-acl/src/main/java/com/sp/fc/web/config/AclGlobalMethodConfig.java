...
public class AclGlobalMethodConfig extends GlobalMethodSecurityConfiguration {
    ...
    protected MethodSecurityExpressionHandler createExpressionHandler() {
        ...
        expressionHandler.setPermissionEvaluator(this.aclPermissionEvaluator());
    ...
    public EhCacheFactoryBean aclEhCacheFactoryBean() {
        ...
        ehCacheFactoryBean.setCacheManager(this.ehcacheFactoryBean().getObject());
