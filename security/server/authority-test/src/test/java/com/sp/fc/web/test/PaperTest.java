...
public class PaperTest extends WebIntegrationTest {
    ...
    void test_2() {
        ...
        ResponseEntity<Paper> response = client.exchange(
            super.uri("/paper/get/2"),
            HttpMethod.GET,
            null,
            new ParameterizedTypeReference<Paper>() {}
        );

        assertEquals(403, response.getStatusCodeValue());
    }

    @DisplayName("3. user2라도 출제 중인 시험지에는 접근할 수 없다.")
    @Test
    void test_3() {
    ...
    void test_4() {
        ...
        ResponseEntity<List<Paper>> response = client.exchange(
            super.uri("/paper/getPapersByPrimary"),
            HttpMethod.GET,
            null,
            new ParameterizedTypeReference<List<Paper>>() {}
        );
